export const data = {
  ...
  "headers": [
    ...
    {
      "level": 2,
      "title": "2.  用ref()处理响应式数据",
      "slug": "_2-用ref-处理响应式数据",
      "children": []
    },
    {
      "level": 2,
      "title": "3. 用reactive()处理响应式数据",
      "slug": "_3-用reactive-处理响应式数据",
      "children": []
    },
    {
      "level": 2,
    ...
    {
      "level": 2,
      "title": "9 . 依赖注入 provide / inject",
      "slug": "_9-依赖注入-provide-inject",
      "children": []
    }
  ],
  "git": {
    "updatedTime": 1649562729000,
    "contributors": [
      {
        "name": "jgoriginal",
