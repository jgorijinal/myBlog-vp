...
![图片](../.vuepress/public/images/ec1.png)

## dashboard 中数据的请求与保存

创建 Vuex 的 dashboard 模块
![图片](../.vuepress/public/images/dash1.png)
![图片](../.vuepress/public/images/dash2.png)
![图片](../.vuepress/public/images/dash3.png)
dashboard 网络请求
![图片](../.vuepress/public/images/dash4.png)
![图片](../.vuepress/public/images/dash5.png)
![图片](../.vuepress/public/images/dash6.png)

dispatch 触发 action
![图片](../.vuepress/public/images/dash7.png)
最终拿到了数据
![图片](../.vuepress/public/images/dash8.png)

## dashboard 页面的基本布局搭建

![图片](../.vuepress/public/images/bj2.png)
![图片](../.vuepress/public/images/bj1.png)

## base-echart 的最基本的封装和 setup 语法的使用

![图片](../.vuepress/public/images/ee1.png)
![图片](../.vuepress/public/images/be1.png)

## useEchart hook 的封装

![图片](../.vuepress/public/images/eh1.png)
useEchart.ts hook
![图片](../.vuepress/public/images/eh2.png)
base-echart.vue
![图片](../.vuepress/public/images/eh3.png)
**但是 options 的数据可能会变, 每当变化时需重新调用 setOptions 方法所以 , 使用了 watchEffect**
![图片](../.vuepress/public/images/we9.png)

## PieEchart 饼图的封装

[options配置官网](https://echarts.apache.org/examples/zh/editor.html?c=pie-simple)
![图片](../.vuepress/public/images/bt.png)

**图是不变的 , 也就是里面的数据可能会变, 所以要单独封装**

![图片](../.vuepress/public/images/bt1.png)

pie-echart.vue **封装目的 : 在外面要使用 pieEchart 时 , 只需通过 props 传具体数据 pieData 即可**
![图片](../.vuepress/public/images/bt2.png)
![图片](../.vuepress/public/images/bt3.png)
**其实要传入 base-echart options 属性被改了 , 所以每当 options 被改是 base-echart 组件里的 setOptions(props.options) 要重新调一遍, 所以**

base-echart.vue
![图片](../.vuepress/public/images/we9.png)

dashboard.vue **使用封装的 pieEchart**
![图片](../.vuepress/public/images/bt4.png)
![图片](../.vuepress/public/images/bt5.png)

## rose-echart 玫瑰图的封装

[options配置官网](https://echarts.apache.org/examples/zh/editor.html?c=pie-roseType-simple)
**封装思路跟上面 PieEchart 一模一样**
![图片](../.vuepress/public/images/re.png)
![图片](../.vuepress/public/images/re1.png)

**rose-echart.vue**
![图片](../.vuepress/public/images/re2.png)
![图片](../.vuepress/public/images/re3.png)
page-echart/index.ts **导出**
![图片](../.vuepress/public/images/re4.png)
dashboard.vue 使用
![图片](../.vuepress/public/images/re5.png)

## line-echart 折线图的封装

[options配置官网](https://echarts.apache.org/examples/zh/editor.html?c=area-stack)
![图片](../.vuepress/public/images/line1.png)
![图片](../.vuepress/public/images/line2.png)

props 接受 x 轴的 y 轴的数据 , 都是数组 , 就这么简单

line-echart.vue
![图片](../.vuepress/public/images/line3.png)
![图片](../.vuepress/public/images/line4.png)
page-echart/index.ts **导出**
![图片](../.vuepress/public/images/line5.png)
dashboard.vue **使用 line-echart**
![图片](../.vuepress/public/images/line6.png)
![图片](../.vuepress/public/images/line7.png)

## bar-echart 柱状图的封装

**封装思路跟 lineEchart 一模一样**

[options配置官网](https://echarts.apache.org/examples/zh/editor.html?c=bar-gradient)

![图片](../.vuepress/public/images/bar1.png)
![图片](../.vuepress/public/images/bar2.png)

bar-echart.vue 
![图片](../.vuepress/public/images/bar3.png)
![图片](../.vuepress/public/images/bar4.png)
![图片](../.vuepress/public/images/bar5.png)
base-echart/index.ts  **导出**
![图片](../.vuepress/public/images/bar6.png)
dashboard.vue  **使用 bar-echart组件**
![图片](../.vuepress/public/images/bar7.png)
![图片](../.vuepress/public/images/bar8.png)

## map-echart 地图的封装
![图片](../.vuepress/public/images/mee.png)

![图片](../.vuepress/public/images/me1.png)
china.json在附件里

useEchart.ts
![图片](../.vuepress/public/images/me2.png)
![图片](../.vuepress/public/images/me3.png)

**下面附件**

map-echart.vue
![图片](../.vuepress/public/images/me6.png)
![图片](../.vuepress/public/images/me7.png)
![图片](../.vuepress/public/images/me8.png)
dashboard.vue  使用 map-echart 地图组件
![图片](../.vuepress/public/images/me00.png)
![图片](../.vuepress/public/images/me11.png)
## 附件
