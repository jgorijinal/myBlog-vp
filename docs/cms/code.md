...
![图片](../.vuepress/public/images/cz1.png)
并且在package.json中进行配置：

![图片](../.vuepress/public/images/cz2.png)
...
- 在Vue2中使用过element-ui，而element-plus正是element-ui针对于vue3开发的一个UI组件库；
...
![图片](../.vuepress/public/images/global1.png)
